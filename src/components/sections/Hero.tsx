...
const Hero = forwardRef((props, ref: ForwardedRef<HTMLElement>) => {
    return (
        // In your Hero component's section element:
        <section
            ref={ref}
            id="home"
            className="relative min-h-screen flex items-center px-4 sm:px-6 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden pt-20">
            ...
            <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 items-center relative z-10">
                ...
                <motion.div
                    ...
                    <motion.p
                        ...
                        Full Stack Developer building scalable web platforms and intuitive mobile applications using modern frameworks like
                        React, Next.js, Node.js, NestJS, and React Native
                    </motion.p>
                    ...
                    {[
                        {
                            ...
                            icon: (
                                <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-blue-400/20 flex items-center justify-center">📍</div>
                            ),
                            color: "blue",
                        },
                        {
                        ...
                        },
                        {
                            ...
                            content: "2+ Years",
                            icon: (
                                <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-green-400/20 flex items-center justify-center">
                                    🌟
                                </div>
                            ),
                            color: "green",
                            ...
                            <div className="flex items-center gap-3 sm:gap-4 mb-2 sm:mb-3">
                                <div
                                    className={`p-2 rounded-lg ${
                                        item.color === "blue" ? "bg-blue-400/20 text-blue-400" : "bg-green-400/20 text-green-400"
                                    }`}>
                                    {item.icon}
                                </div>
                                <h3 className="text-sm sm:text-base font-medium text-gray-300">{item.title}</h3>
                            </div>
                            <p className={`text-xs sm:text-sm ${item.color === "blue" ? "text-blue-300" : "text-green-300"} font-mono`}>
                                {item.content}
                            </p>
                        </motion.div>
                    ))}
